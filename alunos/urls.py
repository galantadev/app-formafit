...
urlpatterns = [
    ...
    path('<int:pk>/acompanhamento/<int:ano>/<int:mes>/', views.acompanhamento_mensal, name='acompanhamento_mensal'),
    path('<int:pk>/acompanhamento/<int:ano>/<int:mes>/excluir/', views.excluir_acompanhamento_mensal, name='excluir_acompanhamento'),
]
