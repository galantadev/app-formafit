...
class ExercicioUpdateView(LoginRequiredMixin, UpdateView):
    ...
    model = Exercicio
    form_class = ExercicioForm
    template_name = 'treinos/editar_exercicio.html'
    success_url = reverse_lazy('treinos:exercicios')
    
    def form_valid(self, form):
        messages.success(self.request, f'Exercício "{form.instance.nome}" atualizado com sucesso!')
        return super().form_valid(form)
...
class ExercicioDeleteView(LoginRequiredMixin, DeleteView):
    ...
    """
    model = Exercicio
    template_name = 'treinos/confirmar_exclusao_exercicio.html'
    success_url = reverse_lazy('treinos:exercicios')
    
    def delete(self, request, *args, **kwargs):
        exercicio = self.get_object()
        messages.success(request, f'Exercício "{exercicio.nome}" excluído com sucesso!')
