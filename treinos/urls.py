...
urlpatterns = [
    ...
    path('exercicios/<int:pk>/editar/', views.ExercicioUpdateView.as_view(), name='editar_exercicio'),
    path('exercicios/<int:pk>/excluir/', views.ExercicioDeleteView.as_view(), name='excluir_exercicio'),
