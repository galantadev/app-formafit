...
urlpatterns = [
    ...
    # ===== ROTAS SIMPLIFICADAS =====
    # Dashboard simples
    path('simples/', views.dashboard_financeiro_simples, name='dashboard_simples'),
    
    # Faturas simples - CRUD
    path('faturas-simples/', views.FinanceiroListView.as_view(), name='faturas_lista'),
    path('faturas-simples/criar/', views.FaturaCreateView.as_view(), name='fatura_criar'),
    path('faturas-simples/<int:pk>/editar/', views.FaturaUpdateView.as_view(), name='fatura_editar'),
    path('faturas-simples/<int:pk>/deletar/', views.FaturaDeleteView.as_view(), name='fatura_deletar'),
    
    # AJAX para faturas simples
    path('ajax/fatura/<int:fatura_id>/marcar-paga/', views.marcar_como_paga, name='marcar_como_paga'),
]
